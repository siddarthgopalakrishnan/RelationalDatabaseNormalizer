...
public class Relation {
	...
	*/
	public String normalizeRelationByOneLevel(){
		...
		if(!(this.normalForm >= 2)){
			...
			if(this.twoNFRelations != null){
				for(Relation r : this.twoNFRelations){
					...
					System.out.println("");
                                        ...
                                        s.append("Relation: " + r + "\n");
					s.append("Functional Dependencies: " + r.getFunctionalDependencies() + "\n");
					s.append("Candidate Key(s): " + r.getCandidateKeys() + "\n");
					s.append("Normal Form: " + Utils.getNormalForm(r.getNormalForm()) + "NF" + "\n");
					s.append("\n");
			...
			System.out.println("Relation already in BCNF !!!");
                        s.append("Relation already in BCNF !!!\n");
		}
                return s.toString();
	}
	...
	* Prints the Candidate Keys of the relation.
	*/
	public String getCandidateKeysList(){
            StringBuilder s = new StringBuilder();
            
		for(ArrayList<Attribute> k : this.candidate_key){
			s.append(Utils.stringifyAttributeList(k) + " ; ");
		}
//		System.out.println("");
            return s.toString();
	}
	...
	*/
	public void printNormalForm(){
        ...
        public String getNormalFormString(){
		switch(this.normalForm){
			case 1 :{
				return "Relation is in 1NF";
			}
			case 2 :{
...
//        public String normalFormsTableGenGUI(){
//		StringBuilder s = new StringBuilder();
//		int len = 52;
//		for(int i=0; i<len; i++){
//			s.append("-");
//		}
//		s.append("<br/>");
//		s.append("|  Functional Dependency  | 1NF | 2NF | 3NF | BCNF |<br/>");
//		for(int i=0; i<len; i++){
//			s.append("-");
//		}
//		s.append("<br/>");
...
//	}
	...
	*/
	public void printMinimalCover(){
        ...
        public String getMinimalCoverString(){
		if(this.minimalCover != null){
			StringBuilder s = new StringBuilder();
			s.append("{ ");
			for(FunctionalDependency f : this.minimalCover){
